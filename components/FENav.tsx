...
export default function FENav({props}: any) {
    ...
    return (
        <nav className='absolute z-[999]'>
            <div className='relative'>
                <MenuIcon className='z-50 absolute bg-black/40 rounded-full text-white m-2' height={40} width={40} onClick={() => setOpen(!open)} />
                <div className={`${open ? 'bg-slate-500 w-full rounded-br-lg' : 'hidden'} `}>
