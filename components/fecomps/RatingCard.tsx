...
export default function RatingCard() {
    ...
    return (
        <section className='m-6 bg-gradient-to-b from-rating-dark-blue to-rating-dark-blue/25 px-4 py-6 w-full h-full rounded-2xl overflow-hidden space-y-6 max-w-sm md:px-6'>
            {thankYou ? (
                <>
                    ...
                    <div className='flex justify-center items-center'>
                        <div className='bg-rating-medium-gray/10 rounded-full text-rating-orange py-2 px-4'>
                            <p className="text-[15px]">You selected {rating} out of 5</p>
                        </div>
                    </div>
                ...
                <>
                    <div className='flex'>
                        <div className='bg-rating-medium-gray/10 rounded-full p-4'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <p className='text-rating-light-gray text-[15px]'>
                            Please let us know how we did with your support request. All feedback is appreciated to help us improve our offering!
                        </p>
                    </div>
                    <form className='space-y-5'>
                        <fieldset className='flex gap-3 md:justify-between text-rating-medium-gray'>
                            <div>
                                <input
                                    type='radio'
                                    name="rating"
                                ...
                                <label
                                    htmlFor="option1"
                                    className='cursor-pointer select-none rounded-full flex justify-center items-center w-[49px] aspect-square text-center bg-rating-medium-gray/10 hover:bg-rating-orange hover:text-rating-white peer-checked:bg-rating-light-gray peer-checked:text-rating-white transition-all duration-150'
                                >
                                    1
                                </label>
                            </div>
                        ...
                        <button onClick={handleSubmit} className='bg-rating-orange w-full rounded-full p-2 hover:bg-rating-white hover:text-rating-orange'>Submit</button>
                    </form>
                </>
            )}
